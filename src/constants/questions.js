    ...
    v: [
      {
        ...
        t: '300 рублей',
        a: '<div><span>Мимо.</span><p class="result-text">Вы, наверное, знаете по собственному опыту? Но теперь, <strong>если совершить покупки в МЕГЕ на сумму от 3000 рублей, можно сэкономить</strong> и на этом! Достаточно показать чеки своих покупок на стойке информации. <br/><strong>Подробнее об акции <a href="https://mega.ru/events/2021/34613/nn/" target="_blank" class="result-link">тут</a>.</strong></p></div>',
        isCorrect: false,
      },
      {
